...
class Product(models.Model):
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, blank=True, null=True, related_name="products"
    )

    price = models.DecimalField(verbose_name="Цена", max_digits=10, decimal_places=2)
    discount = models.DecimalField(
        verbose_name="Скиддка", max_digits=5, decimal_places=2, default=0  # type: ignore
    )
    ...
    def description(self):
        ...
        elif len(self.full_description) < 100:
...
class Comment(models.Model):
    ...
    product_estimation = models.DecimalField(
        "Оценка товара", max_digits=3, decimal_places=2
    )

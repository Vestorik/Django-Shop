...
from goods.models.product_models import (
    Product,
    ProductImage,
...
class ImageSerializer(serializers.ModelSerializer):
    ...
    def get_src(self, object: ProductImage) -> str | None:
        """get url of image
        if the object belongs src, return the src url, else None
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    rate = serializers.DecimalField(source="product_estimation", max_digits=3, decimal_places=2)
